# 🚀 Guía de Ejecución Local de VetConnect (Paso a Paso)

Esta guía está diseñada para que cualquier persona del equipo (incluso sin experiencia previa programando) pueda encender todo el sistema VetConnect (Base de datos, Web y App Móvil) en su propia computadora y probarlo con su celular conectado por cable.
...
La PC se comunicará por el cable con el celular, abrirá Expo Go automáticamente y cargará VetConnect sin depender de la red Wi-Fi de la empresa.
...
¡Listo! Con estas 3 terminales corriendo, ya tenés el control absoluto de VetConnect en tu PC.
