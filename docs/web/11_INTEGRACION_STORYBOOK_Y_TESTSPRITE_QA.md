...
| **TS-E2E-04** | **Triaje Clínico y Espera de Guardia** | Selecciona mascota, marca síntomas agudos (ej. convulsión / disnea), evalúa cálculo de prioridad roja. | La consulta se crea en estado `WAITING` con badge de severidad y contador de triaje activo. |
