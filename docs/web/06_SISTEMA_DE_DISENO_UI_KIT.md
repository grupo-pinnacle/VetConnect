...
> 📌 **Fuente Única de Verdad (SSOT):** El inventario exhaustivo de selectores `data-testid` y textos vinculantes para los 29 tests de Vitest se encuentra formalmente centralizado en [`docs/web/AGENT_CODING_SPEC.md (§7)`](./AGENT_CODING_SPEC.md#7-contrato-de-data-testid-y-selectores-29-tests-de-vitest).
