...
- **Consumo de Datos & Cache:** **TanStack React Query v5** para queries asíncronas con reintentos exponenciales, paginación infinita en historial clínico y revalidación en foco de ventana.
