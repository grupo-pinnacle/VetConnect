  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col lg:grid lg:grid-cols-12 text-slate-800 antialiased selection:bg-emerald-500 selection:text-white">
      ...
      <section className="hidden lg:flex lg:col-span-5 bg-gradient-to-br from-[#06241D] via-[#0A332A] to-[#041B15] text-white p-8 lg:p-12 flex-col justify-between border-b lg:border-b-0 lg:border-r border-[#0D3E33] relative overflow-hidden">
        {/* Halos cálidos sutiles de fondo (esmeralda y ámbar) */}
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-3.5 max-w-lg mb-7">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 text-xs font-black tracking-wider uppercase backdrop-blur-sm">
              ...
              <span>ALTA DE CUENTA CLÍNICA &bull; 100% HOMOLOGADA</span>
            </div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-white leading-tight font-display">
              Tu tranquilidad y la salud de tu mascota, en un solo lugar.
            </h1>
            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed font-normal">
              Creá tu usuario en menos de un minuto como tutor o como médico veterinario colegiado. Consultas en alta definición, recetas oficiales SENASA con código QR y cero estrés para tus compañeros.
            </p>
          </div>

          {/* Tarjeta de Garantías Humanas y Clínicas */}
          <div className="p-4 rounded-3xl bg-[#031D17]/90 border border-emerald-800/40 shadow-xl backdrop-blur-xl space-y-3 max-w-md">
            <div className="flex items-start gap-3 p-2.5 rounded-2xl bg-white/[0.03]">
              ...
              <div>
                <p className="text-xs font-bold text-white">Atención con Cariño y Empatía</p>
                <p className="text-[11px] text-slate-300 leading-snug">Cuidado médico cercano sin traslados traumáticos ni estrés de sala de espera</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-2.5 rounded-2xl bg-white/[0.03]">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-300 leading-snug">Homologación ante SENASA Res. 1442/2021 para médicos veterinarios</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-2.5 rounded-2xl bg-white/[0.03]">
              ...
              <div>
                <p className="text-xs font-bold text-white">Transmisión Cifrada en Alta Definición</p>
                <p className="text-[11px] text-slate-300 leading-snug">WebRTC SFU de grado broadcast provisto por Pinnacle Group</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Columna Derecha: Tarjeta de Registro con Mascota Hamster Duolingo en Paleta Cálida */}
      <section className="lg:col-span-7 bg-[#F8F5EE] border-t lg:border-t-0 lg:border-l border-[#E6E0D3] flex items-center justify-center p-6 sm:p-12 lg:p-14 relative">
        <div className="w-full max-w-lg bg-white p-8 sm:p-11 rounded-[32px] shadow-[0_20px_60px_-15px_rgba(7,36,30,0.07)] border border-[#E8E2D6] transition-all duration-300 animate-fadeIn">
          ...
          <div className="text-center mb-7">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EAF5F0] border border-emerald-200/90 text-[#0A342B] text-[11px] font-semibold mb-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className={`py-2.5 px-3.5 rounded-2xl border text-xs font-bold transition-all duration-150 active:scale-[0.98] cursor-pointer flex items-center justify-center gap-2 ${
                    formData.role === 'CLIENT'
                      ? 'border-[#0A342B] bg-[#EAF5F0] text-[#0A342B] shadow-sm ring-1 ring-[#0A342B]/20'
                      : 'border-[#DCD5C8] bg-[#FAF8F4] text-[#5C564C] hover:bg-[#F2ECE0]'
                  }`}
                >
            ...
            {formData.role === 'VET' && (
              <div className="p-4 bg-[#EAF5F0] border border-emerald-200/90 rounded-2xl space-y-1.5 animate-fadeIn">
                <label
                  htmlFor="register-license"
                  className="block text-xs font-bold uppercase tracking-wider text-[#06241D] mb-1"
                >
                ...
                <input
                  ...
                  onBlur={() => setIsInputFocused(false)}
                  required
                  className="w-full px-4 py-2.5 bg-white border border-emerald-300 rounded-xl text-[#1E1C18] text-sm focus:outline-none focus:ring-4 focus:ring-[#0A342B]/10 focus:border-[#0A342B] placeholder:text-[#A39E93] transition-all duration-200"
                  placeholder="Ej. MP-1234"
                />
                <p className="text-[11px] text-[#0A342B] mt-1">
