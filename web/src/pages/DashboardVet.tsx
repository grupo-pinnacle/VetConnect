          ...
          <div className="bg-white/90 backdrop-blur-sm p-5 rounded-2xl border border-[#E8E2D5] shadow-sm flex flex-col justify-between">
            ...
            <div className="mt-2 flex items-baseline gap-2">
              ...
              <div className="flex items-center text-amber-400">
                {[1, 2, 3, 4, 5].map((s) => (
                  <Star key={s} className="w-3.5 h-3.5 fill-current" aria-hidden="true" />
                ))}
              </div>
            </div>
            <p className="text-xs mt-1 text-emerald-700 font-semibold flex items-center gap-1">
              <Sparkles className="w-3.5 h-3.5" aria-hidden="true" />
              Nivel de excelencia SENASA
            </p>
          </div>
        </section>
